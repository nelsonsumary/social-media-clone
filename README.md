...
EMAIL_TOKEN=sk-socialclone-secret-2025
...
| `EMAIL_TOKEN` | — | Secret token for email service authentication |
| `FACEBOOK_CLIENT_ID` | — | Facebook App ID for Facebook Sign-In |
